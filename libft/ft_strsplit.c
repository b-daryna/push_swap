...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/12/09 19:11:13 by dbessmer          #+#    #+#             */
/*   Updated: 2016/12/22 10:13:57 by dbessmer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static int		ft_lettercounter(char const *s, int i, char c)
{
	int j;
...
static char		*ft_makeword(const char *s, int x, char c)
{
	int		i;
	int		let;
	char	*str;
